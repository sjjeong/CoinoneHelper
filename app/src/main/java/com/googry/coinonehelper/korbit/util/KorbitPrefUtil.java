package com.googry.coinonehelper.korbit.util;
...
public class KorbitPrefUtil {
    ...
    public static void saveOrderbook(Context context, KorbitCoinType coinType, String value) {
    ...
    public static String loadOrderbook(Context context, KorbitCoinType coinType) {
        return getSharedPrefs(context).getString(getKey(coinType, KEY_SUFFIX_ORDERBOOK), EMPTY);
    }

    public static void saveCompleteOrder(Context context, KorbitCoinType coinType, String value) {
        SharedPreferences.Editor editor = getEditor(context);
    ...
    public static String loadCompleteOrder(Context context, KorbitCoinType coinType) {
        return getSharedPrefs(context).getString(getKey(coinType, KEY_SUFFIX_COMPLETE_ORDER), EMPTY);
    }

    public static void saveTicker(Context context, KorbitCoinType coinType, String value) {
        SharedPreferences.Editor editor = getEditor(context);
    ...
    public static String loadTicker(Context context, KorbitCoinType coinType) {
    ...
    private static String getKey(KorbitCoinType coinType, String suffix) {
